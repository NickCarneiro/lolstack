...
<div class="entry grid_6 push_5 omega" id="passwordresetform">
<span class="pic_instructions">Reset password</span>
	...
	<label class="passwordlabel" for="submit"></label><input id="resetbutton" class="pmsubmit" type="submit" name="submit" value="Reset Password">
